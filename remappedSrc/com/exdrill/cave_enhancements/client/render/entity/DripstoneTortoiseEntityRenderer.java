...
public class DripstoneTortoiseEntityRenderer extends MobRenderer<DripstoneTortoiseEntity, DripstoneTortoiseEntityModel<DripstoneTortoiseEntity>> {
    ...
    @Override
    public ResourceLocation getTexture(DripstoneTortoiseEntity entity) {
        return new ResourceLocation(CaveEnhancements.MODID, "textures/entity/dripstone_tortoise/dripstone_tortoise.png");
    }
}
