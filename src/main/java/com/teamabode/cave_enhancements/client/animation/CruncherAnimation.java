...
public class CruncherAnimation {
    ...
    static {
        WALKING = AnimationDefinition.Builder.withLength(0.8F)
                ...
                .addAnimation(
                        ...
                        new AnimationChannel(
                                ...
                                new Keyframe(0.2F, KeyframeAnimations.degreeVec(22.5F, 0, -15F), AnimationChannel.Interpolations.CATMULLROM),
                ...
                .addAnimation(
                        ...
                        new AnimationChannel(
                                AnimationChannel.Targets.ROTATION,
                                new Keyframe(0.0F, KeyframeAnimations.degreeVec(22.5F, 0, 0), AnimationChannel.Interpolations.CATMULLROM),
                                new Keyframe(0.0F, KeyframeAnimations.degreeVec(-22.5F, 0, 15F), AnimationChannel.Interpolations.CATMULLROM),
                                new Keyframe(0.0F, KeyframeAnimations.degreeVec(22.5F, 0, 0), AnimationChannel.Interpolations.CATMULLROM)
                        )
                )
                .addAnimation(
        ...
        CHOMPING = AnimationDefinition.Builder.withLength(1.0F).build();
    }
}
