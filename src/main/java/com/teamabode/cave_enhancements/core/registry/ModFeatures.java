...
public class ModFeatures {
    ...
    public static class ModPlacedFeatures {
        ...
        public static final Holder<PlacedFeature> ROSE_QUARTZ_PILLAR_FLOOR_PATCH = register("rose_quartz_pillar_floor_patch", ModConfiguredFeatures.NOTHING, List.of());
        public static final Holder<PlacedFeature> ROSE_QUARTZ_PILLAR_CEILING_PATCH = register("rose_quartz_pillar_ceiling_patch", ModConfiguredFeatures.NOTHING, List.of());
